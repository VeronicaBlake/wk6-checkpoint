<template>
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-2 flex-grow-1 p-2 my-2">
        ...
        <!-- <router-link :to="{name:'HomePage', params: {id: post.id}}"> router linksa re for changing pages, link this to the creator profile-->
        <!-- </router-link> -->
      </div>
    </div>
  </div>
